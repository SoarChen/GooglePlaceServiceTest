...
/**
 * Created by Soar on 2015/12/31.
 */
public class GooglePlaceWebAPI {

//    public static PlacesList search(double latitude, double longitude, double radius, String types)
//            throws Exception {
//
//        try {
//
